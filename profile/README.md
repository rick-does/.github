...
- **[json-razor](https://github.com/rick-does/json-razor)** — Collapses repeated structures in JSON, YAML, and NDJSON so the schema is easier to see. Install with `pip install json-razor`.
...
- **[pith](https://github.com/rick-does/pith)** — CLI prose analysis for developers and technical writers. Analyzes markdown and PDFs for structure, readability, and style issues. Fully local, no backend. Install with `pip install git+ssh://git@github.com/rick-does/pith.git`.
